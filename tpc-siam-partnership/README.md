# tpc-siam-partnership — Content Tech × Bureau of Wonders 合作提案（英文 · 32 頁）
...
| 17–26 | （產品段） | Moana / Banana / Reels Studio / Adriana / Stacey（沿用） |
| 27–28 | ecosystem | 生態系 chapter + Rytho demo（raccoon / luna 深入頁已刪，finale 小卡保留） |
| 29 | siam_cobuild | 共建泰國 Content Tech：左卡 WE BRING THE TECHNOLOGY（agents ring 插圖）× 右卡 YOU BRING THE CULTURE（BOW 遊船晚宴照 `bow_event.jpg`）· `sp-cobuild` |
| 30 | siam_framework | Content Tech flywheel（4 相位卡含 agent 頭像）＋三條合作軌＋90-day pilot 收尾條 · `sp-flywheel` |
| 31 | finale | 生態系收斂（ecosystem grow-up） |
| 32 | redeem | 100 Banana Split credits · FOR THE BOW TEAM |
...
全部集中在 `</style>` 前的 `sp-*` 區塊：`sp-statgrid / sp-rows / sp-insightgrid / sp-wall / sp-flywheel / sp-bio / sp-photowall / sp-thwall / sp-brandwall / sp-cobuild`。
...
- 驗證：`https://turncloud.thepocket.company/siam-partnership/?v=<隨機>` → 32 頁、`../img/` 素材全 200、第 16 頁貼文可點開。
