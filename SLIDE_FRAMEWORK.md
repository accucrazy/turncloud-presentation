...
### 結構（`rtx-talk-deck/index.html` 是唯一進入點，共 34 頁 = 12 + 7 + 15）
...
# 驗證 https://turncloud.thepocket.company/rtx-talk/?v=<隨機> → 34 頁、nemo 圖 200、pocket 段影片可播、img/local/*.mp4 200
```
