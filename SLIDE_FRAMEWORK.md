...
| 06（新增） | `intro_thailand` | **Accucrazy Thailand 2019 實績**（`sp-thwall` 兩張圖）：Oriental Princess「Beauty Intelligence」AI 膚質檢測 campaign（`th_op.jpg`）＋ Meitu 2019 Thailand review（In-App media campaigns × Lazada LazLIVE、兩階段 Skin Analysis，`th_meitu.jpg`）。訊息：2019 就在曼谷落地 AI beauty tech |
